...
- [Data Type Basics](/blog/basics-intro-to-data-types)
...
- [Referencing layers and compositions](/blog/basics-referance-layers)
- [Objects](/blog/basics-objects)
- [Native attributes](/blog/basics-native-attributes)
- [Functions](/blog/basics-functions)
- [Native methods](/blog/basics-native-methods)
...
You can override this placeholder by typing in some JavaScript code that, when run, gives After Effects a value in the same structure (or [type](/blog/basics-intro-to-data-types/)) as the original.
