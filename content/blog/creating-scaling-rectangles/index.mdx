...
It comes in the form of a `js›.jsx` file, like [eKeys](/blog/how-to-animate-with-expressions) and [aeFunctions](/blog/using-aefunctions), that you import into your After Effects project.
