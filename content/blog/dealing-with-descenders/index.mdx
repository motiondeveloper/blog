...
To save writing out this large amount of code on each text (and box) layer, we've implemented these ideas in external expression libraries [aeFunctions](/blog/using-aefunctions) and [eBox](https://github.com/motiondeveloper/ebox).
...
We then use the library [eBox](https://github.com/motiondeveloper/ebox) to create a rectangular path based on the `js›textRect` object.
...
Using [eBox](https://github.com/motiondeveloper/ebox) allows you to scale this rectangle from any anchor point.