...
In an expression you perform actions such as assigning values to variables, calling functions or performing math. These actions are called 'statements'.
...
Expression statements (statements that produce a value), such as:
