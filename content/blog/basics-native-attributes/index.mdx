...
After Effects will insert the `js›thisProperty` object reference automatically when using native attributes of the current property. This means you can write `js›name` or `js›speed` without `js›thisProperty`.
